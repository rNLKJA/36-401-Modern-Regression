---
title: "36-401, Chapter 3: Beta Inference"
...
p-value is NOT strong evidence in favor of $H_0$

\- the p-value is NOT equal to P(H0 true given the data)

\- $p= 0.048$ is not very different from $p= 0.053$, even though only
the former leads to rejecting $H_0$ at level $\alpha = 0.05$.
