...
\- $\sigma^2$ is the *population* MSE of the *optimal* predictor
$E[Y|X]$

\- The *training* (in-sample) average squared residual $\text{RSS}/n$ is
too optimistic because the same data were used to estimate two
parameters; each estimated parameter effectively “uses up” one degree of
freedom, reducing residual variability

\- Adjusting by $(n-2)$ corrects this optimism in expectation
